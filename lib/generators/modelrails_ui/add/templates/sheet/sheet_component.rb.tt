...
module UI
  # A native `<dialog>` side panel — pinned to a chosen edge and sliding in from that edge.
  # Usage, options and the accessibility contract: docs/components/sheet.md in the
